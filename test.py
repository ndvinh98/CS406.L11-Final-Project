...
from yolo.model import yolo_eval, yolo_body
...
if __name__ == '__main__':
    ...
    yolo_model = Yolo(score, iou, anchors_path, classes_path, model_path)


    img = "000341.jpg"
    image = Image.open(img)

    result = yolo_model.detect_image(image, model_image_size=model_image_size)
    plt.imshow(result)
    plt.show()
